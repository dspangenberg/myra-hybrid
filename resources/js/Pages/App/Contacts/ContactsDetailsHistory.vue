<template>
  <div class="flex space-x-6 mb-3">
    <stormy-shadow-box class="flex-shrink-1 content-between max-h-fit w-2/3">
          ...
          >
            <div class="flex space-x-3">
              ...
              <div>
                ...
                <div class="mt-1 text-sm text-gray-700 leading-normal">
                  <p>{{ comment.body }}</p>
                </div>
                <li class="mt-2 text-sm space-x-2">
    ...
    <div class="flex-1 w-1/3 mt-3 space-y-6">
      <ContactsDetailsSidePhone :contact="contact" />
      <ContactsDetailsSide :contact="contact" />
    </div>
  </div>
</template>
<script setup>
import ContactsDetailsSide from './ContactsDetailsSide.vue'
import ContactsDetailsSidePhone from './ContactsDetailsSidePhone.vue'
...
/*
 x-data="select({ data:
 , emptyOptionsMessage: '', name: 'country', placeholder: '' })"
*/
